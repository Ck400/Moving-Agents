...
# Setup agents
enemies = []
dog = Dog(Vector(Constants.DISPLAY_WIDTH/2 - Constants.DOG_SIZE.x/2, Constants.DISPLAY_HEIGHT/2 - Constants.DOG_SIZE.y/2), Constants.DOG_SIZE, Constants.DOG_MOVESPEED, dogImage)

for num in range(Constants.SHEEP_COUNT):
    enemy = Enemy(Vector(random.randrange(0, Constants.DISPLAY_WIDTH - Constants.SHEEP_SIZE.x/2), random.randrange(0, Constants.DISPLAY_HEIGHT - Constants.SHEEP_SIZE.y/2)), Constants.SHEEP_SIZE, Constants.SHEEP_MOVESPEED, sheepImage)
